...
export const allQuestions: Question[] = [
  ...
  { // ★ 뒤집힘
    ...
    choiceA: { label: "대부분 조용히 쉬고 있다", value: "C" },
    choiceB: { label: "거의 하루종일 활발하다", value: "H" },
  },
  {
    id: "q3",
    axis: "XG",
  ...
  { // ★ 뒤집힘
    ...
    choiceA: { label: "보호자가 시작하면 따라서 논다", value: "A" },
    choiceB: { label: "장난감을 물어와서 놀자고 한다", value: "B" },
  },
  // --- 라운드 2 ---
  { // ★ 뒤집힘
    id: "q5",
    ...
    choiceA: { label: "자기 자리에서 지켜본다", value: "L" },
    choiceB: { label: "신나서 뛰어가 인사한다", value: "S" },
  },
  {
    id: "q6",
    axis: "HC",
  ...
  { // ★ 뒤집힘
    ...
    choiceA: { label: "익숙한 길을 가야 편안해한다", value: "G" },
    choiceB: { label: "새로운 길을 가면 신나한다", value: "X" },
  },
  {
    id: "q8",
    axis: "BA",
  ...
  { // ★ 뒤집힘
    ...
    choiceA: { label: "자연스럽게 쉬러 간다", value: "C" },
    choiceB: { label: "더 놀자고 보챈다", value: "H" },
  },
  {
    id: "q11",
    axis: "XG",
  ...
  { // ★ 뒤집힘
    ...
    choiceA: { label: "보호자 지시를 잘 따른다", value: "A" },
    choiceB: { label: "자기 방식대로 하려 한다", value: "B" },
  },
  // --- 라운드 4 ---
  { // ★ 뒤집힘
    id: "q13",
    ...
    choiceA: { label: "상대가 다가오면 받아준다", value: "A" },
    choiceB: { label: "먼저 다가가서 놀이를 시작한다", value: "B" },
  },
  {
    id: "q14",
    axis: "XG",
  ...
  { // ★ 뒤집힘
    ...
    choiceA: { label: "자기 자리에서 별 반응 없다", value: "L" },
    choiceB: { label: "따라가려고 현관에서 기다린다", value: "S" },
  },
  // --- 라운드 5 ---
  {
    id: "q17",
  ...
  { // ★ 뒤집힘
    ...
    choiceA: { label: "곧바로 쓰러져서 잠든다", value: "C" },
    choiceB: { label: "집에 와서도 한동안 흥분 상태", value: "H" },
  },
  { // ★ 뒤집힘
    id: "q19",
    axis: "XG",
    text: "밥그릇 위치를 바꿨을 때 {name}의 반응은?",
    choiceA: { label: "원래 자리에서 두리번거린다", value: "G" },
    choiceB: { label: "금방 찾아서 적응한다", value: "X" },
  },
  {
    id: "q20",
    axis: "BA",
